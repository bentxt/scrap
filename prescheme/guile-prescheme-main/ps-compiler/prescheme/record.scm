...
;;;
;;;   scheme48-1.9.2/ps-compiler/prescheme/record.scm
;;;
;;; Records that translate into C structs.
;;;
;;; Representation of record types.

(define-module (ps-compiler prescheme record)
...
;; TODO: port expand-define-record-type to syntax-case
